...
class SubscriberTest extends TestCase
{
    ...
    {
    	$subscriber = factory('App\Subscriber')->make()->toArray();
    ...
    {
    	$subscriber = factory('App\Subscriber')->make(['email' => 'test@'])->toArray();
    ...
    {
    	$subscriber = factory('App\Subscriber')->make(['email' => ''])->toArray();
    	$this->withExceptionHandling()
    			->post('/subscribers/new', $subscriber)->assertSessionHasErrors('email');
    }
